...
function fetchManuscripts() {
  ...
  function success(response) {
    return { type: manuscriptConstants.FETCH_MANUSCRIPTS_SUCCESS, payload: response };
  }
  function failure(response) {
    return { type: manuscriptConstants.FETCH_MANUSCRIPTS_FAILURE, payload: response };
  }
...
function fetchManuscript(id) {
  ...
  function success(response) {
    return { type: manuscriptConstants.FETCH_MANUSCRIPT_SUCCESS, payload: response };
  }
  function failure(response) {
    return { type: manuscriptConstants.FETCH_MANUSCRIPT_FAILURE, payload: response };
  }
